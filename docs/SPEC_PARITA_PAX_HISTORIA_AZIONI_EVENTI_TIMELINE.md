...
**Rimangono aperti:** (a) G22 (lettore di sessione separato — oggi il lettore è il banner del playback §9.3 con «Continua»/«Intervieni qui» più la timeline esistente); (b) il rilascio coordinato backend/frontend con verifica pubblica e campagna comparativa E2E su Pax Historia (§16, §17, G23) che richiede autorizzazione del proprietario. Non eseguire deploy sulla base di questo documento.
