# World Story — Technical Plan
=========================

## Project Overview

**World Story** — это open-source аналог paxhistoria.co с поддержкой кастомных карт. Позволяет создавать альтернативные миры на основе любых карт (книги, фильмы, игры).
