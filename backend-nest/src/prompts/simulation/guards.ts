...
- Niente dispacci di riempimento (§5.11): vietati l'avanzare del calendario, il riepilogo di fine anno, la contabilità ordinaria già calcolata dal motore (bilancio, magazzino, estrazione, rifinanziamento di routine) e la notizia che nulla è accaduto. Se il periodo non produce una svolta, emetti **meno** eventi, non eventi vuoti.
